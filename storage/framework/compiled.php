...
class ErrorHandler
{
    ...
    {
        $this->handleError(E_USER_DEPRECATED, 'The ' . __METHOD__ . ' method is deprecated since version 2.6 and will be removed in 3.0. Use the handleError() method instead.', 'C:\\wamp\\www\\snj_bus\\vendor\\symfony\\debug\\Symfony\\Component\\Debug\\ErrorHandler.php', __LINE__, array());
...
class EventServiceProvider extends ServiceProvider
{
    protected $listen = array('App\\Events\\SomeEvent' => array('App\\Listeners\\EventListener'));
    public function boot(DispatcherContract $events)
    {
        parent::boot($events);
    }
